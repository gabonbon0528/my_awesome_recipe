...
export default async function Page({
  ...
  return (
    <Flex padding={4} flexDirection={"column"} justifyContent={"center"} alignItems={"center"} gap={4}>
      ...
      <Table.Root size="md" rounded={"md"} variant="outline" width={"80%"}>
        <Table.Header>
          <Table.Row >
            ...
            <Table.ColumnHeader textAlign={"center"}>比例</Table.ColumnHeader>
            <Table.ColumnHeader textAlign={"center"}>鎖定比例</Table.ColumnHeader>
            <Table.ColumnHeader textAlign={"center"}>使用原料</Table.ColumnHeader>
